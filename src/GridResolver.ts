import {
  getDefaultGridMultiplier,
  getMinGridSize,
  isGridDetectionEnabled,
} from "./settings";

export { getMinGridSize, isGridDetectionEnabled };

export function getMapScaleMultiplier(): number {
  // Back-compatible name for integrations that imported this from the original
  // DDB Importer implementation.
  return getDefaultGridMultiplier();
}
