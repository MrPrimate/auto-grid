...
function detectGridFromGrayscaleSingle(
  ...
  // When the caller hasn't supplied a prior, bootstrap the template anchor from
  ...
  if (templateAnchor !== null && templateAnchor >= 4) {
    ...
    // less confidence in the seed than in a caller-supplied prior.
...
export async function detectGrid(
  ...
  // Default 4096 keeps most battle maps at native resolution
